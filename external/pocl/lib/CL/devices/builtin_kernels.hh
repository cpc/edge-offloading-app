...
enum BuiltinKernelId : uint16_t {
  ...
  POCL_CDBI_DNN_DETECTION_U8 = 38,
  POCL_CDBI_DNN_SEGMENTATION_POSTPROCESS_U8 = 39,
  POCL_CDBI_DNN_SEGMENTATION_RECONSTRUCT_U8 = 40,
  POCL_CDBI_COMPRESS_TO_JPEG_ARGB8888 = 41,
  POCL_CDBI_DECOMPRESS_FROM_JPEG_RGB888 = 42,
  POCL_CDBI_DNN_EVAL_IOU_F32 = 43,
  POCL_CDBI_DECODE_HEVC_YUV420NV21 = 44,
  POCL_CDBI_ENCODE_HEVC_YUV420NV21 = 45,
  POCL_CDBI_CONFIGURE_HEVC_YUV420NV21=46,
  POCL_CDBI_ENCODE_C2_ANDROID_HEVC_YUV420NV21 = 47,
  POCL_CDBI_CONFIGURE_C2_ANDROID_HEVC_YUV420NV21=48,
  POCL_CDBI_INIT_DECOMPRESS_JPEG_HANDLE_RGB888=49,
  POCL_CDBI_DECOMPRESS_FROM_JPEG_HANDLE_RGB888=50,
  POCL_CDBI_DESTROY_DECOMPRESS_JPEG_HANDLE_RGB888=51,
  POCL_CDBI_DNN_CTX_INIT = 52,
  POCL_CDBI_DNN_CTX_DESTROY = 53,
  POCL_CDBI_DNN_CTX_DETECTION_U8 = 54,
  POCL_CDBI_DNN_CTX_SEGMENTATION_POSTPROCESS_U8 = 55,
  POCL_CDBI_DNN_CTX_SEGMENTATION_RECONSTRUCT_U8 = 56,
  POCL_CDBI_DNN_CTX_EVAL_IOU_F32 = 57,
  POCL_CDBI_COMPRESS_TO_JPEG_YUV420NV21 = 58,
  POCL_CDBI_LAST = 59,
...
extern "C"
{
  ...
  POCL_EXPORT
  int pocl_sanitize_builtin_kernel_name2 (char **kernel_name,
                                          char **kernel_meta_name,
                                          int num_builtin_kernels,
                                          char **saved_name);
...
int pocl_sanitize_builtin_kernel_name(cl_kernel kernel, char **saved_name);
  ...
  POCL_EXPORT
  int pocl_restore_builtin_kernel_name2 (char **kernel_name,
                                         char **kernel_meta_name,
                                         int num_builtin_kernels,
                                         char **saved_name);
